...
import com.waa.minionlinemarket.repositories.*;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Autowired
    public OrderServiceImpl(OrderRepository orderRepo, SellerService sellerService, BuyerService buyerService,
                            ShoppingCartRepository shoppingCartRepo, MapperConfiguration mapperConfiguration,
                            AddressRepository addressRepository, SellerRepository sellerRepo) {
    ...
    private LineItemDetailDto mapToLineItemDetailDto(LineItem lineItem) {
        return LineItemDetailDto.builder()
                ...
                .product(mapperConfiguration.convert(lineItem.getProduct(), ProductDetailDto.class))
                .build();
    }
